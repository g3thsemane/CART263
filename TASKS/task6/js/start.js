...
function go_all_stuff() {
  ...
  drawingBoardC.addObj(
    new FreeStyleObj(10, 100, 300, "#CF9FFF", "#CF9FFF", drawingBoardC.context),
  );
  ...
  drawingBoardD.addObj(
    new VideoObj(0, 0, 400, 300, videoEl, drawingBoardD.context),
  );
 ...
 * 
 */
  // event listener for spacebar, removes circle
